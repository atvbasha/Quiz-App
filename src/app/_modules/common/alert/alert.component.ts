...
import { Alert, AlertType, PositiionType } from '@app/_models/alert.model';
...
export class AlertComponent implements OnInit, OnDestroy{
  ...
  @Input() queueAlerts: boolean = false;
  @Input() keepOnRouteChange: boolean = false;
  ...
  public queueAlert(alert: Alert): any{
    if(!alert){
      return null;
    }
